...
{
    str = (char*)ft8lib_trim_front(str);
    ft8lib_trim_back(str);
...
// Convert character to its index (ft8lib_charn in reverse) according to a table
